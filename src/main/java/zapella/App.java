...
public class App {
        public static void main(String[] args) throws SQLException {
                ...
                while (true) {
                        ...
                        System.out
                                        .println(MenuFeatures.CYAN_BACKGROUND + "         MENU INICIAL         "
                                                        + MenuFeatures.ANSI_RESET);
                        System.out.println(
                                        MenuFeatures.ANSI_WHITE_BACKGROUND + "                              "
                                                        + MenuFeatures.ANSI_RESET);
                        ...
                        System.out.println(
                                        MenuFeatures.ANSI_WHITE_BACKGROUND + "                              "
                                                        + MenuFeatures.ANSI_RESET);
                        // If there are no bets, the lines "2-List registered bets" and "3-Start draw
                        // phase" will have a red background
